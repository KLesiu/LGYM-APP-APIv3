...
- Composition guards assert one canonical registry/dispatcher/password adapter, one scoped AppConfig and enum service, one singleton converter per supported unit family, Infrastructure FCM ownership, environment-selected Worker push scheduling, and exact 15-row/16-handler startup validation.
