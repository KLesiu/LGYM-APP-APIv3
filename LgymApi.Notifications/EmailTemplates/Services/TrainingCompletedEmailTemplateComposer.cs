...
internal sealed class TrainingCompletedEmailTemplateComposer : EmailTemplateComposerBase, IEmailTemplateComposer
{
    ...
    private static string GetLocalizedUnitDisplayName(WeightUnits unit, CultureInfo culture)
    {
        ...
        var translationKey = $"{nameof(WeightUnits)}_{enumName}";
