...
public sealed class ReportingApiContractImmutabilityGuardTests
{
    ...
    [
        ...
        new("TrainerReportingController", "RequestRecurringReportNow", "POST", "api/trainer/trainees/{traineeId}/recurring-report-assignments/{id}/request-now"),
    ...
    [
        ...
        new("TrainerReportingController", "RequestRecurringReportNow", "StatusCodes.Status201Created", "RecurringReportAssignmentDto"),
        new("TrainerReportingController", "RequestRecurringReportNow", "StatusCodes.Status400BadRequest", "ResponseMessageDto"),
        new("TrainerReportingController", "RequestRecurringReportNow", "StatusCodes.Status403Forbidden", "ResponseMessageDto"),
        new("TrainerReportingController", "RequestRecurringReportNow", "StatusCodes.Status404NotFound", "ResponseMessageDto"),
        new("TrainerReportingController", "RequestRecurringReportNow", "StatusCodes.Status409Conflict", "ResponseMessageDto"),
